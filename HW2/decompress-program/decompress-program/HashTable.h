...
public:
	...
	const HashedObj & giveElement(int i) const;
...
{
	int collisionNum = 0;
	int currentPos = hash2(x, array.size());
...
template <class HashedObj>
const HashedObj &  HashTable<HashedObj>::giveElement(int i) const {
